...
public class BookARoom {
    ...
    public static void main(String[] args) {
        //Cria um Campus
        CampusFactory cf1 = new CampusFactoryImpl();
        EquipamentoFactory eqf = new NotebookFactory();
        
        Campus c1 = cf1.criarCampus("MocHell", "Rua 2, Vilage 1");
        Campus c2 = cf1.criarCampus("Diamantina", "Rua 3, Vilage 2");
        Campus c3 = cf1.criarCampus("MocHell", "Rua 2, Vilage 1");
        ...
        Notebook e1 = eqf.criarEquipamento("4561561", "Pc", "Notebook");
